...
void ClientHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->readyRead((*reinterpret_cast< std::add_pointer_t<ClientHandler*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[2]))); break;
        case 1: _t->disconnected((*reinterpret_cast< std::add_pointer_t<ClientHandler*>>(_a[1]))); break;
        ...
        {
            using _t = void (ClientHandler::*)(ClientHandler * , const QByteArray & );
            if (_t _q_method = &ClientHandler::readyRead; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ClientHandler::readyRead(ClientHandler * _t1, const QByteArray & _t2)
{
...
// SIGNAL 1
void ClientHandler::disconnected(ClientHandler * _t1)
{
